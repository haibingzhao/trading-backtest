...
class GlobalEquityEngine(BaseEngine):
    ...
    Config keys:
      ...
      - us_commission: default 0.0 (e.g. 0.00005 for $0.005/share)
    ...
    def __init__(self, config: dict, market: str = "us"):
        ...
        self.us_commission: float = config.get("us_commission", 0.0)  # per-share or notional rate
        # HK defaults
    ...
    def calc_commission(self, size: float, price: float, _direction: int, is_open: bool) -> float:
        """US: configurable commission. HK: stamp tax + levies.
        ...
        if self.market == "hk":
            ...
            return comm
        # US: configurable commission (default zero)
        return size * price * self.us_commission
