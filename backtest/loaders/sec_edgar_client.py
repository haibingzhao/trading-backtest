...
UA defaults to a Trading-Backtest contact string overridable via
``TRADING_BACKTEST_SEC_UA``.
...
_MIN_INTERVAL_ENV = "TRADING_BACKTEST_SEC_MIN_INTERVAL"

_TICKERS_URL = "https://www.sec.gov/files/company_tickers.json"
_SUBMISSIONS_URL = "https://data.sec.gov/submissions/CIK{cik}.json"
_COMPANY_FACTS_URL = "https://data.sec.gov/api/xbrl/companyfacts/CIK{cik}.json"

_UA_ENV = "TRADING_BACKTEST_SEC_UA"
...
_DEFAULT_SEC_UA = f"Trading-Backtest/1.0 (contact: trading-backtest@example.com) {DEFAULT_USER_AGENT}"
...
def _user_agent() -> str:
    """Return the compliant contact UA, honoring the ``TRADING_BACKTEST_SEC_UA`` override."""
