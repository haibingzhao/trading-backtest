...
Symbol convention (Trading-Backtest -> Stooq):
...
_MIN_INTERVAL_ENV = "TRADING_BACKTEST_STOOQ_MIN_INTERVAL"
...
def map_symbol(symbol: str) -> str:
    """Translate a Trading-Backtest symbol into Stooq's ticker convention.
