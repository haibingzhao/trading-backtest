...
Symbol convention (Trading-Backtest -> Yahoo):
...
_MIN_INTERVAL_ENV = "TRADING_BACKTEST_YAHOO_MIN_INTERVAL"
...
def map_symbol(symbol: str) -> str:
    """Translate a Trading-Backtest symbol into Yahoo's ticker convention.
